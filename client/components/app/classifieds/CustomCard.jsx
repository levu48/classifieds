...
var { Paper, StylePropable, CardExpandable } = MUI;

CustomCard = React.createClass({
  ...
  render() {
    ...
    let newChildren = React.Children.map(this.props.children, (currentChild) => {
      ...
      if (currentChild.props.actAsExpander === true) {
        ...
        newProps.style = Utils.merge({cursor: 'pointer'}, currentChild.props.style);
      }
